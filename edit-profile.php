			...
			<header>
				...
				<div class="nav">
					...
					<div id="feed_left">
							<div id="postJobAd">
									<h2>Edit Profile</h2>
									<form id="postAdForm" action='edit-profile.php' method="post">
                    <select name="status" class="formTxtInput">
                        <option id="noCheck" value="Customer">Customer</option>
                        <option id="yesCheck" value="Worker">Worker</option>
                    </select><br>
                    <input type="text" name="occupation" id="ifyes" class="formTxtInput"><br>
											<input type="submit" name="changeprofile" value="Confirm" id="submitAd">
									</form>
							</div>
						</div>
